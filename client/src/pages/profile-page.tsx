...
import { updateProfilePicture } from "../api-services/profile-services";
          ...
          <div className="bg-base-300 rounded-xl p-6 space-y-8">
            ...
            <div className="flex flex-col items-center gap-4">
              <div className="relative">
                <img
                  src={
                    selectedFilePreview || user?.profileImage || "/avatar.png"
                  }
                  alt="Profile"
              ...
              <p className="text-sm text-zinc-400">
                {isUpdatingProfile
                  ? "Uploading..."
                  : "Click the camera icon to choose your photo"}
              </p>
            </div>
